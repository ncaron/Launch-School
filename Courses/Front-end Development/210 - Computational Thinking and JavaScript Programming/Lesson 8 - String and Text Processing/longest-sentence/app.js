...
function longestSentence(text) {
  ...
  var wordsArr = sentences.map(function(sentence) {
    return sentence.split(' ');
  });

  var longest = getLongestSentence(wordsArr);
  
  console.log(longest.join(' '));
  console.log('The longest sentence has ' + longest.length + ' words.');
}

function getLongestSentence(wordsArr) {
  return wordsArr.reduce(function(longest, sentence) {
    return longest.length >= sentence.length ? longest : sentence;
  });
}
