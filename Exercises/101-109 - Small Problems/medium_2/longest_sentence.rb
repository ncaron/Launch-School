...
longest_word = text.split.max_by { |word| word.size }

words_sentence = sentences.map { |sentence| sentence.split }
longest_sentence = words_sentence.max_by { |num_words| num_words.size }

words_paragraphs = paragraphs.map { |paragraph| paragraph.split }
longest_paragraph = words_paragraphs.max_by { |num_words| num_words.size }

puts "The longest word is #{longest_word.size} characters long."
puts "The longest sentence is #{longest_sentence.size} words long."
puts "The longest paragraph is #{longest_paragraph.size} words long."