...
# twice (every other value occurs exactly once), how would you determine which
# value occurs twice? Write a method that will find and return the duplicate value
